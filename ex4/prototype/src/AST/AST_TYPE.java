...
public class AST_TYPE extends AST_Node {
	...
	{
		if (num == 0){
			return new BOX(TYPE_INT.getInstance(), null, true, null);
		}
		if (num == 1){
			return new BOX(TYPE_STRING.getInstance(), null, true, null);
		}
		if (num == 2){
			return new BOX(TYPE_VOID.getInstance(), null, true, null);
		}
		if (num == 3){
