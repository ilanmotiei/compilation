...
public class AST_CLASSDEC extends AST_Node {
	...
	// CLASS DOESN'T NEED AN INTERMEDIATE REPRESENTATION, WE WORK WITH THE META DATA WE'VE COLLECTED ABOUT IT AT THE SEMANTIC PARSING.
    
	public void IRMe()
	{
		TYPES.getInstance().Add_Type(this.cls);
	}
}
