...
import IR.IRcommand_Virtualcall;
...
//	}
	...
	public void IRMe() {
		...
		TEMP_LIST params = null;

		if (this.expList != null)
		{
			params = this.expList.IRMe();
		}
		...
		if (this.var != null)
		{
			...
			IR.getInstance().Add_IRcommand(new IRcommand_Virtualcall(obj, var_obj_type, func_name, params));
		}
		else
		{
			IR.getInstance().Add_IRcommand(new IRcommand_Call(func_name, params));
		}	
	}
}
