...
public class SYMBOL_TABLE_GRAPHVIZ
{
	...
	private static SYMBOL_TABLE_GRAPHVIZ instance = null;

	// PREVENT INSTANTIATION 
	private SYMBOL_TABLE_GRAPHVIZ() {}

	// GET SINGLETON INSTANCE
	public static SYMBOL_TABLE_GRAPHVIZ getInstance()
	{
		if (instance == null)
		{
			instance = new SYMBOL_TABLE_GRAPHVIZ();
